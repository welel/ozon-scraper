...
Revision ID: c9081f16f1bf
Revises: 
Create Date: 2024-08-30 22:31:58.733197
...
def upgrade() -> None:
    ...
    sa.Column('url', sa.String(length=2048), nullable=False, comment='URL to the product page'),
    sa.Column('image_url', sa.String(length=2048), nullable=True, comment='URL to the product image'),
    ...
    sa.Column('user_image_url', sa.String(length=2048), nullable=True, comment="URL to the user's profile image"),
    sa.Column('comment_count', sa.Integer(), nullable=False, comment='Number of comments on the review'),
    sa.Column('url', sa.String(length=2048), nullable=False, comment='URL to the review page'),
    ...
    sa.Column('url', sa.String(length=2048), nullable=False, comment='URL to the media resource'),
    sa.Column('template_url', sa.String(length=2048), nullable=True, comment='Template URL for the media resource'),
