...
Revision ID: 80fad5192db8
Revises: 
Create Date: 2024-10-07 21:18:45.800531
...
def upgrade() -> None:
    ...
    op.create_table('ms_ozon_category',
    ...
    sa.PrimaryKeyConstraint('id', name=op.f('pk__ms_ozon_category'))
    )
    op.create_table('ms_ozon_product',
    ...
    sa.ForeignKeyConstraint(['category_id'], ['ms_ozon_category.id'], name=op.f('fk__ms_ozon_product__category_id__ms_ozon_category')),
    sa.PrimaryKeyConstraint('sku_id', name=op.f('pk__ms_ozon_product'))
    )
    op.create_table('ms_scraper_ozon_category_meta',
    ...
    sa.Column('is_parsing_enabled', sa.Boolean(), nullable=False, comment='Wheather to scrape category'),
    sa.ForeignKeyConstraint(['category_id'], ['ms_ozon_category.id'], name=op.f('fk__ms_scraper_ozon_category_meta__category_id__ms_ozon_category')),
    sa.PrimaryKeyConstraint('category_id', name=op.f('pk__ms_scraper_ozon_category_meta'))
    )
    op.create_table('ms_ozon_review',
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False, comment='Timestamp of record creation'),
    sa.Column('updated_at', sa.DateTime(), nullable=False, comment='Timestamp of last record update'),
    sa.ForeignKeyConstraint(['product_sku_id'], ['ms_ozon_product.sku_id'], name=op.f('fk__ms_ozon_review__product_sku_id__ms_ozon_product')),
    sa.PrimaryKeyConstraint('uuid', name=op.f('pk__ms_ozon_review'))
    )
    op.create_table('ms_ozon_review_media',
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False, comment='Timestamp of record creation'),
    sa.Column('updated_at', sa.DateTime(), nullable=False, comment='Timestamp of last record update'),
    sa.ForeignKeyConstraint(['review_uuid'], ['ms_ozon_review.uuid'], name=op.f('fk__ms_ozon_review_media__review_uuid__ms_ozon_review')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk__ms_ozon_review_media'))
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('ms_ozon_review_media')
    op.drop_table('ms_ozon_review')
    op.drop_table('ms_scraper_ozon_category_meta')
    op.drop_table('ms_ozon_product')
    op.drop_table('ms_ozon_category')
